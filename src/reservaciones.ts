//Type Alias (Union literal esctricta)
...
export function crearReserva(
    ...
    const obj : Reserva ={
        ...
        precioTotal, //Lo mismo que en idReserva
        estado: 'Pendiente',
    };
...
export const filtrarPeliculasPorGenero = (cartelera: Pelicula[], genero: TipoPelicula) : Pelicula[] => {
    return cartelera.filter(p => p.genero === genero); //Esto es lo mismo que un forEach con un if dentro.
};